...
X_LOWER = MAP_X_LENGTH/2-MAP_X_LENGTH*MAP_CENTER_TOL/2
X_UPPER = MAP_X_LENGTH/2+MAP_X_LENGTH*MAP_CENTER_TOL/2
Y_LOWER = MAP_Y_LENGTH/2-MAP_Y_LENGTH*MAP_CENTER_TOL/2
Y_UPPER = MAP_Y_LENGTH/2+MAP_Y_LENGTH*MAP_CENTER_TOL/2
...
def evaluate_cc_block(block_msg):
    ...
    if (width > MAP_X_LENGTH*MAP_SIZE_TOL and
